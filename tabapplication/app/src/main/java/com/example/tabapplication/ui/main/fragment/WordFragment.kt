...
import com.example.tabapplication.ui.main.activity.*
...
class WordFragment : Fragment() {
    ...
    savedInstanceState: Bundle?
        ...
        val allword: Button = view!!.findViewById(R.id.btn_allword)
        val wrongword: Button = view.findViewById(R.id.btn_wrongword)
        val myword: Button = view.findViewById(R.id.btn_myword)
...
//            intent.putParcelableArrayListExtra("wordArray", wordArrayList)
        ...
        wrongword.setOnClickListener {
            val intent = Intent(activity, WrongWordActivity::class.java)
//            intent.putParcelableArrayListExtra("wordArray", wordArrayList)
            startActivity(intent)
        }

        myword.setOnClickListener {
            val intent = Intent(activity, MyWordActivity::class.java)
//            intent.putParcelableArrayListExtra("wordArray", wordArrayList)
            startActivity(intent)
        }
        return view
